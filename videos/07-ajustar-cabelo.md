...
* While approaching, she gently touches the upper-front fabric area of the outfit
* The gesture is delicate, subtle and realistic, like naturally showing the texture, fit or front detail of the clothing
* She must only interact with clothing elements that already exist in the original image
* Do NOT create or add any bow, lace, ribbon, tie, cord, knot, string, accessory, decoration or new clothing detail
* No emphasis, no posing, no exaggeration
* The movement feels spontaneous and casual
* After briefly touching the fabric, she naturally releases it
...
* Do not invent new clothing features
* Do not modify the original clothing design
* Preserve the exact outfit from the source image

ADDITIONAL NATURAL GESTURE, VERY SUBTLE:

* After the main body movement sequence, the subject briefly raises one hand
* She lightly brushes her hair backward near the side of the head
...
During the brief fabric touch:

* A subtle smile appears briefly
* Smile is soft and natural, not exaggerated
* Slight cheek movement only

After releasing the fabric:
...
* Preserve original outfit exactly
* Preserve all existing clothing details exactly as they appear in the source image
* Do not add bows, lace, ribbons, knots, cords, strings, jewelry, buttons, embroidery or decorative details that are not already present
* Preserve hair movement with slight natural motion
...
* No added lace
* No added ribbon
* No added clothing decoration

FINAL RESULT:
A hyper-realistic POV fashion video where the subject feels alive and human, with natural facial expression changes, occasional soft smiles, neutral moments in between, subtle head turns, and realistic clothing interaction without altering or adding any new clothing detail. The final video should be indistinguishable from a real casual phone recording.
